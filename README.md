...
## Environments
- Preview: https://main--itc-sunrisespices--aemysites.aem.page/
- Live: https://main--itc-sunrisespices--aemysites.aem.live/
- Block Library: https://main--itc-sunrisespices--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `itc-sunrisespices` directory in your favorite IDE and start coding :)
